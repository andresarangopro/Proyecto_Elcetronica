...
public class DispositivosBT extends AppCompatActivity {
    ...
    public void onResume()
    {
        ...
        mPairedDevicesArrayAdapter = new ArrayAdapter(this, android.R.layout.simple_list_item_1);//<-<- PARTE A MODIFICAR >->->
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
       ...
       //     address = addres;
            ...
            Intent i = new Intent(DispositivosBT.this, NavigationActivity.class);//<-<- PARTE A MODIFICAR >->->
